...
class CustomDropDown extends StatelessWidget {
  ...
  const CustomDropDown({super.key, required this.hintText, this.value});
    ...
    return Observer(
      builder: (context) {
        return DropdownButtonFormField(
            ...
            label: RichText(
              text: TextSpan(
                children: [
                  TextSpan(
                    text: hintText,
                    style: OTextStyle.labelSmall.copyWith(color: Themes.hintText),
                  ),
                  TextSpan(
                    text: ' * ',
                    style: OTextStyle.labelMedium.copyWith(color: Themes.starColor),
                  ),
                ],
              ),
            ),
            labelStyle: OTextStyle.labelSmall.copyWith(color: Themes.hintText),
          ...
          items:
              getItems(store.year).map<DropdownMenuItem<String>>((String value) {
