          ...
          label: RichText(
            text: TextSpan(
              children: [
                TextSpan(
                  text: hintText,
                  style: OnestopFonts.w500.size(14).setColor(Themes.hintText),
                ),
                TextSpan(
                  text: ' * ',
                  style: OnestopFonts.w500.size(16).setColor(Themes.starColor),
                ),
              ],
            ),
          ),
          labelStyle: OnestopFonts.w500.size(14).setColor(Themes.hintText),
