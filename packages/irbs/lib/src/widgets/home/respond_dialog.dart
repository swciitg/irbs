                ...
                children: [
                  ...
                  RichText(
                      ...
                      text: TextSpan(children: [
                        ...
                        TextSpan(
                          text: widget.bookingData.roomDetails.roomType == 'club'
                              ? 'Club Room'
                  ...
                  RichText(
                    ...
                    children: [
                      TextSpan(
                        ...
                        style:
                            OnestopFonts.w500.size(11).setColor(Themes.iconColor).letterSpace(0.5),
                      ),
                      TextSpan(
                      ...
                      child: Form(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintStyle:
                                OnestopFonts.w400.size(12).setColor(Themes.comet).letterSpace(0.5),
                            // contentPadding: EdgeInsets.zero,
                            enabledBorder: OutlineInputBorder(
                                borderSide:
                                    BorderSide(width: 0.5, color: Themes.white.withOpacity(0.5)),
                          ...
                          onTap: () async {
                            ...
                            try {
                              bool status = await APIService()
                                  .rejectBooking(widget.bookingData.id, textEditingController.text);
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            ...
                            try {
                              bool status = await APIService()
                                  .acceptBooking(widget.bookingData.id, textEditingController.text);
                              widget.commonStore.pending = widget.commonStore.pending + 1;
