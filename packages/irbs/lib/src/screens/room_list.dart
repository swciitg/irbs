          ...
          child: Consumer<RoomListProvider>(
            ...
            return SingleChildScrollView(
              child: Column(
                ...
                children: [
                  const RoomSearchBar(),
                  roomListProvider.pinnedRooms.isEmpty
                      ? const SizedBox()
                      : const Padding(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding: const EdgeInsets.only(
                                            top: 15, bottom: 16),
                                        child: Text(
                                          roomListProvider.pinnedRooms[index],
                                  ...
                                  Row(
                                    children: [
                                      IconButton(
                                        ...
                                        onPressed: () {
                                          roomListProvider.modifyPinnedRooms(
                                              roomListProvider
                                                  .pinnedRooms[index]);
                                        },
                                      ),
                  ...
                  roomListProvider.commonRooms.isEmpty
                      ? const SizedBox()
                      : const Padding(
                          padding: EdgeInsets.symmetric(
                              horizontal: 16, vertical: 12),
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding: const EdgeInsets.only(
                                            top: 15, bottom: 16),
                                        child: Text(
                                          roomListProvider.commonRooms[index],
                                          style: const TextStyle(
                                              fontSize: 14,
                                              color: Colors.white,
                                              fontFamily: 'Montserrat',
                  ...
                  roomListProvider.clubRooms.isEmpty
                      ? const SizedBox()
                      : const Padding(
                          padding: EdgeInsets.symmetric(
                              horizontal: 16, vertical: 12),
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.start,
                            children: [
                              Text('Club Rooms', style: roomTypeStyle),
                            ],
                          ),
                        ),
                  roomListProvider.clubRooms.isEmpty
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding: const EdgeInsets.only(
                                            top: 15, bottom: 16),
                                        child: Text(
                                          roomListProvider.clubRooms[index],
                                          style: const TextStyle(
                                              fontSize: 14,
                                              color: Colors.white,
                                              fontFamily: 'Montserrat',
